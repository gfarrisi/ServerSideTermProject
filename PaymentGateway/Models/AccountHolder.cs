...
namespace PaymentGateway.Models
{
    public class AccountHolder
    {
        ...
        public AccountHolder(String api_key, String merchantID, String virtualWalletID,String accountHolder_Name, String accountHolder_AccountType, int accountHolder_AccountNumber,decimal balance)
        {
